...
import { n as DEFAULT_AGENT_ID } from "./session-key-ezJ78bLC.js";
import { t as createSubsystemLogger } from "./subsystem-CAq3uyo7.js";
import { h as resolveUserPath } from "./utils-CKSrBNwq.js";
import { a as resolveAgentModelPrimary } from "./agent-scope-4nAkb5YL.js";
import { a as saveJsonFile, i as loadJsonFile, r as resolveCopilotApiToken, t as DEFAULT_COPILOT_API_BASE_URL } from "./github-copilot-token-pGSmVaW-.js";
...
//#endregion
export { resolveApiKeyForProfile as $, buildSyntheticModelDefinition as A, loadShellEnvFallback as B, VENICE_BASE_URL as C, SYNTHETIC_BASE_URL as D, buildVeniceModelDefinition as E, resolveAwsSdkEnvVarName as F, buildCloudflareAiGatewayModelDefinition as G, shouldDeferShellEnvFallback as H, resolveEnvApiKey as I, resolveAuthProfileOrder as J, resolveCloudflareAiGatewayBaseUrl as K, resolveModelAuthMode as L, getCustomProviderApiKey as M, requireApiKey as N, SYNTHETIC_DEFAULT_MODEL_REF as O, resolveApiKeyForProvider as P, resolveProfileUnusableUntilForDisplay as Q, getShellEnvAppliedKeys as R, resolveImplicitProviders as S, VENICE_MODEL_CATALOG as T, shouldEnableShellEnvFallback as U, resolveShellEnvFallbackTimeoutMs as V, CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF as W, markAuthProfileFailure as X, isProfileInCooldown as Y, markAuthProfileUsed as Z, buildXiaomiProvider as _, CODEX_CLI_PROFILE_ID as _t, isCliProvider as a, listProfilesForProvider as at, resolveImplicitBedrockProvider as b, DEFAULT_PROVIDER as bt, parseModelRef as c, upsertAuthProfile as ct, resolveConfiguredModelRef as d, updateAuthProfileStoreWithLock as dt, CHUTES_AUTHORIZE_ENDPOINT as et, resolveDefaultModelForAgent as f, resolveAuthStorePath as ft, XIAOMI_DEFAULT_MODEL_ID as g, CLAUDE_CLI_PROFILE_ID as gt, resolveThinkingDefault as h, resolveAuthProfileDisplayLabel as ht, getModelRefStatus as i, repairOAuthProfileIdMismatch as it, getApiKeyForModel as j, SYNTHETIC_MODEL_CATALOG as k, resolveAllowedModelRef as l, ensureAuthProfileStore as lt, resolveModelRefFromString as m, resolveOpenClawAgentDir as mt, buildConfiguredAllowlistKeys as n, generateChutesPkce as nt, modelKey as o, markAuthProfileGood as ot, resolveHooksGmailModel as p, resolveAuthStorePathForDisplay as pt, auth_profiles_exports as q, buildModelAliasIndex as r, parseOAuthCallbackInput as rt, normalizeProviderId as s, setAuthProfileOrder as st, buildAllowedModelSet as t, exchangeChutesCodeForTokens as tt, resolveAllowlistModelKey as u, loadAuthProfileStore as ut, normalizeGoogleModelId as v, DEFAULT_CONTEXT_TOKENS as vt, VENICE_DEFAULT_MODEL_REF as w, resolveImplicitCopilotProvider as x, normalizeProviders as y, DEFAULT_MODEL as yt, getShellPathFromLoginShell as z };