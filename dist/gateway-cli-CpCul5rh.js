...
import { D as isCliProvider, E as getModelRefStatus, F as resolveHooksGmailModel, L as resolveThinkingDefault, N as resolveConfiguredModelRef, P as resolveDefaultModelForAgent, _t as DEFAULT_PROVIDER, gt as DEFAULT_MODEL, ht as DEFAULT_CONTEXT_TOKENS, j as resolveAllowedModelRef } from "./auth-profiles-CbjyhfM5.js";
...
import { n as createBrowserControlContext, r as startBrowserControlServiceFromConfig } from "./control-service-C411KAd7.js";
...
import { n as callGateway, o as loadGatewayTlsRuntime$1 } from "./call-BJSLz4K5.js";
...
import { r as buildChannelUiCatalog, t as applyPluginAutoEnable } from "./plugin-auto-enable-DHSSP121.js";
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-DmOwDqqs.js";
import "./logging-CfEk_PnX.js";
import "./accounts-MJ4mYpJN.js";
import { $ as approveNodePairing, $n as getTtsProvider, $t as listAgentsForGateway, A as resolveHeartbeatVisibility, An as isGatewaySigusr1RestartExternallyAllowed, B as createReplyDispatcher, Bn as normalizeCronJobCreate, Bt as clearAgentRunContext, C as buildControlUiAvatarUrl, Cr as formatUserTime, Ct as normalizeMimeList, Dt as runEmbeddedPiAgent, En as runWithModelFallback, Et as stopSubagentsForRequester, Fn as formatRestartSentinelMessage, Ft as detectSuspiciousPatterns, G as normalizeSendPolicy, Gn as enqueueSystemEvent, Gt as resolveAnnounceTargetFromKey, H as getCliSessionId, Hn as migrateLegacyCronPayload, Ht as getAgentRunContext, It as getHookType, J as primeRemoteSkillsCache, Jn as requestHeartbeatNow, Jt as applyModelOverrideToSessionEntry, K as resolveSendPolicy, Kn as isSystemEventContextChanged, L as getChannelActivity, Ln as summarizeRestartSentinel, Lt as isExternalHookSession, M as getLastHeartbeatEvent, Mn as setGatewaySigusr1RestartPolicy, Mr as createInternalHookEvent, Mt as registerUnhandledRejectionHandler, N as onHeartbeatEvent, Nn as consumeRestartSentinel, Nr as registerInternalHook, Nt as createOpenClawTools, O as createReplyPrefixOptions, On as authorizeGatewaySigusr1Restart, Ot as abortEmbeddedPiRun, Pn as formatDoctorNonInteractiveHint, Pr as triggerInternalHook, Pt as buildSafeExternalPrompt, Q as setSkillsRemoteRegistry, Qn as OPENAI_TTS_VOICES, Rt as initSubagentRegistry, S as CONTROL_UI_AVATAR_PREFIX, Sn as resolveSessionDeliveryTarget, Sr as normalizePollInput, St as extractImageContentFromSource, T as resolveAssistantAvatarUrl, Tr as resolveUserTimezone, Tt as isAbortTrigger, U as setCliSessionId, Ut as onAgentEvent, Vn as normalizeCronJobPatch, Vt as emitAgentEvent, W as runCliAgent, Wt as registerAgentRunContext, X as refreshRemoteBinsForConnectedNodes, Xn as getPluginToolMeta, Y as recordRemoteNodeInfo, Yt as loadProviderUsageSummary, Z as refreshRemoteNodeBins, Zn as OPENAI_TTS_MODELS, _n as resolveOutboundSessionRoute, _t as DEFAULT_INPUT_PDF_MAX_PAGES, an as archiveFileOnDisk, ar as resolveTtsPrefsPath, at as verifyNodeToken, br as stripHeartbeatToken, bt as DEFAULT_INPUT_TIMEOUT_MS, cn as readSessionPreviewItemsFromTranscript, cr as setTtsProvider, d as handleReset, dr as setCommandLaneConcurrency, dt as DEFAULT_INPUT_FILE_MAX_BYTES, en as listSessionsFromStore, er as isTtsEnabled, et as listNodePairing, fn as lookupContextTokens, fr as CommandLane, ft as DEFAULT_INPUT_FILE_MAX_CHARS, gn as ensureOutboundSessionEntry, gr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, gt as DEFAULT_INPUT_MAX_REDIRECTS, hr as isDiagnosticsEnabled, ht as DEFAULT_INPUT_IMAGE_MIMES, in as resolveSessionModelRef, ir as resolveTtsConfig, it as updatePairedNodeMetadata, jn as scheduleGatewaySigusr1Restart, jr as clearInternalHooks, k as buildHistoryContextFromEntries, kn as consumeGatewaySigusr1RestartAuthorization, kr as resolveAgentIdentity, kt as waitForEmbeddedPiRunEnd, ln as resolveSessionTranscriptCandidates, lr as textToSpeech, lt as applyVerboseOverride, mn as normalizeGroupActivation, mr as stopDiagnosticHeartbeat, mt as DEFAULT_INPUT_IMAGE_MAX_BYTES, n as handleSlackHttpRequest, nn as loadSessionEntry, nr as resolveTtsApiKey, nt as renamePairedNode, on as capArrayByJsonBytes, or as resolveTtsProviderOrder, ot as getSkillsSnapshotVersion, pn as clearSessionQueues, pr as startDiagnosticHeartbeat, pt as DEFAULT_INPUT_FILE_MIMES, q as getRemoteSkillEligibility, qt as loadModelCatalog, rn as resolveGatewaySessionStoreTarget, rr as resolveTtsAutoMode, rt as requestNodePairing, sn as readSessionMessages, sr as setTtsEnabled, st as registerSkillsChangeListener, t as loadOpenClawPlugins, tn as loadCombinedSessionStoreForGateway, tr as isTtsProviderConfigured, tt as rejectNodePairing, un as stripEnvelopeFromMessages, ut as parseVerboseOverride, vt as DEFAULT_INPUT_PDF_MAX_PIXELS, w as normalizeControlUiBasePath, wn as resetDirectoryCache, wr as resolveUserTimeFormat, wt as formatZonedTimestamp, xn as resolveOutboundTarget, xt as extractFileContentFromSource, yt as DEFAULT_INPUT_PDF_MIN_TEXT_CHARS, z as dispatchInboundMessage, zn as writeRestartSentinel, zt as resolveAgentTimeoutMs } from "./loader-PqvF84Si.js";
...
import { m as detectMime, r as saveMediaBuffer } from "./routes-BqCULFri.js";
import { B as normalizeThinkLevel, F as formatXHighModelHint, H as normalizeVerboseLevel, P as formatThinkingLevels, R as normalizeElevatedLevel, V as normalizeUsageDisplay, W as supportsXHighThinking, z as normalizeReasoningLevel } from "./pi-embedded-helpers-BdEtYGar.js";
import { o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads } from "./deliver-gTKS6yGz.js";
import { $ as stripPluginOnlyAllowlist, F as resolveExplicitAgentSessionKey, I as resolveMainSessionKey, J as collectExplicitAllowlist, L as resolveMainSessionKeyFromConfig, P as resolveAgentMainSessionKey, Q as resolveToolProfilePolicy, S as mergeDeliveryContext, Y as expandPolicyWithPluginGroups, Z as normalizeToolName, b as deliveryContextFromSession, d as loadSessionStore, g as updateSessionStore, q as buildPluginToolGroups, w as normalizeSessionDeliveryFields, z as snapshotSessionOrigin } from "./sandbox-CAzTXzmk.js";
import "./channel-summary-B_C4bXX1.js";
import { i as getMachineDisplayName, r as createBrowserRouteDispatcher } from "./wsl-BqAv8Zjj.js";
...
import { c as normalizeExecApprovals, g as saveExecApprovals, l as readExecApprovalsSnapshot, m as resolveExecApprovalsSocketPath, r as ensureExecApprovals } from "./exec-approvals-C-Dx43cR.js";
import "./redact-B8YiFlwn.js";
import "./tool-display-DmgKs6-V.js";
import { t as parseAbsoluteTimeMs } from "./parse-gTOGQPH6.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-ucXSmjx7.js";
import { i as loadSessionUsageTimeSeries, l as hasNonzeroUsage, n as loadCostUsageSummary, r as loadSessionCostSummary, t as discoverAllSessions } from "./session-cost-usage-C9bgCj2T.js";
import { n as formatTokenCount, r as formatUsd } from "./usage-format-E3bMcUMV.js";
import { c as resolveSubagentToolPolicy, i as filterToolsByPolicy, o as resolveEffectiveToolPolicy, s as resolveGroupToolPolicy } from "./commands-CByaGyAZ.js";
...
import "./register.subclis-B3nOjivx.js";
import "./completion-cli-B9IXLgiC.js";
import { n as createOutboundSendDeps, t as createDefaultDeps } from "./deps-DwpIwq-u.js";
import "./daemon-runtime-BcBr8yJC.js";
import "./service-_JwSmGSn.js";
import "./systemd-8sIc6isV.js";
import "./shared-fnGLWyZ6.js";
import { a as runDaemonStop, i as runDaemonStart, n as runDaemonStatus, o as runDaemonUninstall, r as runDaemonRestart, s as runDaemonInstall } from "./daemon-cli-Dac6ErOa.js";
...
import { i as probeGateway } from "./audit-CiOqbn9_.js";
import { g as discoverGatewayBeacons, n as installSkill } from "./onboard-skills-BQDd1fcD.js";
import { a as resolveControlUiRootOverrideSync, c as getHealthSnapshot, d as runHeartbeatOnce, f as setHeartbeatsEnabled, n as ensureControlUiAssetsBuilt, o as resolveControlUiRootSync, p as startHeartbeatRunner, s as formatHealthChannelLines } from "./health-format-B5Hg8mtj.js";
import { S as normalizeUpdateChannel, _ as resolveNpmChannelTag, h as compareSemverStrings, m as checkUpdateStatus, t as runGatewayUpdate, y as DEFAULT_PACKAGE_CHANNEL } from "./update-runner-BNcrduqF.js";
...
import { f as runOnboardingWizard, n as getStatusSummary, s as loadAgentIdentity, u as loadAgentIdentityFromWorkspace } from "./status-65c4p3r_.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-DtXrj3fy.js";
import "./tui-D2aYfza-.js";
import { i as setGatewayWsLogStyle, n as logWs, r as summarizeAgentEventForWsLog, t as formatForLog } from "./ws-log-CPCss-ho.js";
...
import { a as createOutboundSendDeps$1, i as resolveAgentOutboundTarget, r as resolveAgentDeliveryPlan, t as agentCommand } from "./agent-BFEwY-__.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-urGvjB0L.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		const { loadSessionLogs } = await import("./session-cost-usage-C9bgCj2T.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./control-service-C411KAd7.js").then((n) => n.t);
