import { H as normalizeThinkLevel, I as formatThinkingLevels, K as supportsXHighThinking, L as formatXHighModelHint, W as normalizeVerboseLevel } from "./pi-embedded-helpers-BINPWZGz.js";
import { En as emitAgentEvent, I as runWithModelFallback, Lr as resolveAgentTimeoutMs, M as resolveSessionDeliveryTarget, Pt as getRemoteSkillEligibility, Sr as loadModelCatalog, Tn as clearAgentRunContext, _r as applyVerboseOverride, c as runEmbeddedPiAgent, gr as applyModelOverrideToSessionEntry, hr as clearSessionAuthProfileOverride, i as runCliAgent, j as resolveOutboundTarget, kn as registerAgentRunContext, mr as lookupContextTokens, n as getCliSessionId, o as resolveSendPolicy, qt as getSkillsSnapshotVersion, r as setCliSessionId, wn as AGENT_LANE_NESTED } from "./reply-D5DQmXpo.js";
import { d as resolveAgentIdFromSessionKey, l as normalizeAgentId, u as normalizeMainKey } from "./session-key-ezJ78bLC.js";
import { c as defaultRuntime, h as DEFAULT_CHAT_CHANNEL } from "./subsystem-CAq3uyo7.js";
import { a as resolveAgentModelPrimary, i as resolveAgentModelFallbacksOverride, o as resolveAgentSkillsFilter, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, x as ensureAgentWorkspace } from "./agent-scope-4nAkb5YL.js";
import { a as isCliProvider, bt as DEFAULT_PROVIDER, d as resolveConfiguredModelRef, h as resolveThinkingDefault, lt as ensureAuthProfileStore, o as modelKey, t as buildAllowedModelSet, vt as DEFAULT_CONTEXT_TOKENS, yt as DEFAULT_MODEL } from "./model-selection-RM_zZLQN.js";
import { t as formatCliCommand } from "./command-format-ChfKqObn.js";
import { i as loadConfig } from "./config-B1A9pWK-.js";
import { r as normalizeChannelId, t as getChannelPlugin } from "./plugins-BlF-ZPkH.js";
import { A as resolveSessionResetPolicy, D as resolveSessionKey, I as resolveExplicitAgentSessionKey, O as evaluateSessionFreshness, T as normalizeAccountId, d as loadSessionStore, g as updateSessionStore, j as resolveSessionResetType, k as resolveChannelResetConfig } from "./sandbox-7ysDY42x.js";
import { r as buildWorkspaceSkillSnapshot } from "./skills-D5JDj3TR.js";
import { a as isInternalMessageChannel, d as resolveMessageChannel, i as isGatewayMessageChannel, l as normalizeMessageChannel, n as isDeliverableMessageChannel, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-Bpfe5l5f.js";
import { n as resolveSessionFilePath, o as resolveStorePath } from "./paths-CR6bsrfc.js";
import { a as normalizeOutboundPayloadsForJson, i as normalizeOutboundPayloads, r as formatOutboundPayloadLog, t as deliverOutboundPayloads } from "./deliver-DsD2VjZR.js";
import { l as hasNonzeroUsage } from "./session-cost-usage-C5MMXOZi.js";
