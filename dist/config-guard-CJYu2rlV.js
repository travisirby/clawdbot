...
import { N as resolveConfiguredModelRef, _ as ensureAuthProfileStore, _t as DEFAULT_PROVIDER, b as resolveAuthStorePath, g as upsertAuthProfile, gt as DEFAULT_MODEL, ht as DEFAULT_CONTEXT_TOKENS, it as resolveEnvApiKey, k as normalizeProviderId, n as resolveAuthProfileOrder, s as resolveApiKeyForProfile } from "./auth-profiles-CbjyhfM5.js";
...
import { c as writeConfigFile, h as parseDurationMs, i as loadConfig, o as readConfigFileSnapshot, r as createConfigIO } from "./config-BK7bfee5.js";
import { n as movePathToTrash } from "./server-context-yKyxyxOJ.js";
import { i as randomIdempotencyKey, n as callGateway } from "./call-BJSLz4K5.js";
...
import { Cn as formatTargetDisplay, D as runMemoryStatus, E as registerMemoryCli, Tn as CHANNEL_MESSAGE_ACTION_NAMES, Un as CHANNEL_TARGETS_DESCRIPTION, Wn as CHANNEL_TARGET_DESCRIPTION, _ as randomToken, a as applyWizardMetadata, c as ensureWorkspaceAndSessions, d as handleReset, dn as resolveCommitHash, f as moveToTrash, fn as lookupContextTokens, hn as runMessageAction, i as DEFAULT_WORKSPACE, l as formatControlUiSshHint, m as openUrl, s as detectBrowserOpenSupport, v as resolveControlUiLinks, x as waitForGatewayReachable } from "./loader-PqvF84Si.js";
...
import { n as setupChannels } from "./onboard-channels-TDSi2_lP.js";
...
import { d as loadSessionStore } from "./sandbox-CAzTXzmk.js";
import { r as runCommandWithRuntime } from "./cli-utils-ByANh4Sp.js";
import { n as ensurePluginRegistryLoaded, t as hasExplicitOptions } from "./command-options-Bxm1y9Bh.js";
import { l as getVerboseFlag, o as getFlagValue, r as registerSubCliCommands, s as getPositiveIntFlagValue, u as hasFlag } from "./register.subclis-B3nOjivx.js";
import { n as parsePositiveIntOrUndefined, t as collectOption } from "./helpers-EKm3X92T.js";
import { n as callGatewayFromCli, t as addGatewayClientOptions } from "./gateway-rpc-BjPZ6XIf.js";
import { t as createDefaultDeps } from "./deps-DwpIwq-u.js";
import { a as gatewayInstallErrorHint, h as assertSupportedRuntime, i as buildGatewayInstallPlan, r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-BcBr8yJC.js";
import { t as resolveGatewayService } from "./service-_JwSmGSn.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-8sIc6isV.js";
import { t as renderTable } from "./table-CJSx0YID.js";
import { d as applyAuthChoice, f as applyOpenAIConfig, h as promptAuthChoiceGrouped, m as applyGoogleGeminiModelDefault, p as upsertSharedEnvVar, u as warnIfModelConfigLooksOff } from "./onboard-skills-BQDd1fcD.js";
import { l as healthCommand } from "./health-format-B5Hg8mtj.js";
import { $ as setVeniceApiKey, C as applyMoonshotConfig, D as applyOpenrouterConfig, F as applyXaiConfig, G as setCloudflareAiGatewayConfig, J as setMinimaxApiKey, K as setGeminiApiKey, L as applyXiaomiConfig, N as applyVercelAiGatewayConfig, Q as setSyntheticApiKey, W as setAnthropicApiKey, X as setOpencodeZenApiKey, Y as setMoonshotApiKey, Z as setOpenrouterApiKey, ct as buildTokenProfileId, et as setVercelAiGatewayApiKey, f as applyOpencodeZenConfig, g as applyMinimaxConfig, j as applyVeniceConfig, k as applySyntheticConfig, lt as validateAnthropicSetupToken, m as applyMinimaxApiConfig, nt as setXiaomiApiKey, q as setKimiCodingApiKey, rt as setZaiApiKey, tt as setXaiApiKey, v as applyAuthProfileConfig, w as applyMoonshotConfigCn, x as applyKimiCodeConfig, y as applyCloudflareAiGatewayConfig, z as applyZaiConfig } from "./github-copilot-auth-BVzge74E.js";
import { n as logConfigUpdated, t as formatConfigPath } from "./logging-Cc7m6PTv.js";
import { a as findAgentEntryIndex, c as pruneAgentConfig, d as parseIdentityMarkdown, f as runOnboardingWizard, i as buildAgentSummaries, l as identityHasValues, o as listAgentEntries, r as applyAgentConfig, s as loadAgentIdentity, t as statusCommand } from "./status-65c4p3r_.js";
import { a as createOutboundSendDeps, n as resolveSessionKeyForRequest, t as agentCommand } from "./agent-BFEwY-__.js";
import { t as formatHelpExamples } from "./help-format-CfZ94KRN.js";
import { i as CONFIGURE_WIZARD_SECTIONS, n as configureCommand, r as configureCommandWithSections } from "./configure-unxWJGAP.js";
import { n as ensureSystemdUserLingerNonInteractive } from "./systemd-linger-SsSOsJST.js";
import { n as loadAndMaybeMigrateDoctorConfig, t as doctorCommand } from "./doctor-DHRmJRXe.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Config helpers (get/set/unset). Run without subcommand for the wizard.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configure wizard sections (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { CONFIGURE_WIZARD_SECTIONS, configureCommand, configureCommandWithSections } = await import("./configure-unxWJGAP.js").then((n) => n.t);
