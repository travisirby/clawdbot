...
import { $ as CHANNEL_TARGETS_DESCRIPTION, $t as registerMemoryCli, E as runMessageAction, Et as resolveControlUiLinks, F as CHANNEL_MESSAGE_ACTION_NAMES, Ir as applyTemplate, N as formatTargetDisplay, St as openUrl, Tt as randomToken, _t as formatControlUiSshHint, bt as moveToTrash, en as runMemoryStatus, et as CHANNEL_TARGET_DESCRIPTION, ft as DEFAULT_WORKSPACE, gt as ensureWorkspaceAndSessions, ht as detectBrowserOpenSupport, in as installUnhandledRejectionHandler, kt as waitForGatewayReachable, lt as resolveCommitHash, mr as lookupContextTokens, on as waitForever, pt as applyWizardMetadata, t as getReplyFromConfig, tn as monitorWebChannel, yt as handleReset } from "./reply-D5DQmXpo.js";
import { g as resolveStateDir, i as isNixMode, m as resolveOAuthDir, o as resolveConfigPath, r as STATE_DIR, u as resolveGatewayPort } from "./paths-scjhy7N2.js";
import { l as normalizeAgentId, n as DEFAULT_AGENT_ID, t as DEFAULT_ACCOUNT_ID } from "./session-key-ezJ78bLC.js";
import { D as info, E as danger, I as colorize, L as isRich, M as setVerbose, R as theme, S as normalizeChatChannelId, c as defaultRuntime, h as DEFAULT_CHAT_CHANNEL, l as restoreTerminalState, r as enableConsoleCapture, s as visibleWidth, v as getChatChannelMeta } from "./subsystem-CAq3uyo7.js";
import { _ as shortenHomePath, b as toWhatsappJid, d as normalizeE164, f as resolveConfigDir, g as shortenHomeInString, h as resolveUserPath, n as assertWebChannel, p as resolveHomeDir } from "./utils-CKSrBNwq.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-HEWTMJ7j.js";
import { c as resolveDefaultAgentId, f as DEFAULT_AGENT_WORKSPACE_DIR, h as DEFAULT_IDENTITY_FILENAME, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, w as resolveDefaultAgentWorkspaceDir, x as ensureAgentWorkspace } from "./agent-scope-4nAkb5YL.js";
...
import { r as normalizeEnv, t as isTruthyEnvValue } from "./env-0_mKbEWW.js";
import { c as writeConfigFile, h as parseDurationMs, i as loadConfig, j as VERSION, o as readConfigFileSnapshot, r as createConfigIO } from "./config-B1A9pWK-.js";
...
import { D as resolveSessionKey, E as deriveSessionKey, d as loadSessionStore, m as saveSessionStore } from "./sandbox-7ysDY42x.js";
import "./image-Dm4oIWJ9.js";
import "./pi-model-discovery-CV2V1HHz.js";
import { E as formatUncaughtError, c as describePortOwner, l as ensurePortAvailable, s as PortInUseError, u as handlePortError } from "./chrome-BNSd7Bie.js";
import "./skills-D5JDj3TR.js";
import "./routes-D-UAHT8-.js";
import { n as movePathToTrash } from "./server-context-vChIAqjH.js";
import { h as GATEWAY_CLIENT_NAMES, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES } from "./message-channel-Bpfe5l5f.js";
import "./logging-BWRYHvLp.js";
import "./accounts-DkUtJa-O.js";
import { a as resolveSessionTranscriptsDirForAgent, i as resolveSessionTranscriptsDir, o as resolveStorePath } from "./paths-CR6bsrfc.js";
...
import { i as randomIdempotencyKey, n as callGateway } from "./call-DtqJOzE9.js";
...
import { t as createDefaultDeps } from "./deps-Cungkzfd.js";
import { l as ensureBinary, u as promptYesNo } from "./tailscale-BVGD9gSD.js";
import { t as isMainModule } from "./is-main-B6kCyqsv.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-DP3DsVge.js";
import { a as gatewayInstallErrorHint, g as assertSupportedRuntime, i as buildGatewayInstallPlan, r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-7qf__-lc.js";
import { a as buildAgentSummaries, c as loadAgentIdentity, f as parseIdentityMarkdown, i as applyAgentConfig, l as pruneAgentConfig, n as statusCommand, o as findAgentEntryIndex, s as listAgentEntries, t as runOnboardingWizard, u as identityHasValues } from "./onboarding-BlJrKxt5.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-CSZtxHTa.js";
import { n as logConfigUpdated, t as formatConfigPath } from "./logging-TXWhN8jG.js";
...
import { c as registerSubCliCommands, d as getPositiveIntFlagValue, f as getVerboseFlag, l as getCommandPath, m as hasHelpOrVersion, p as hasFlag, u as getFlagValue } from "./completion-cli-B576kqUp.js";
import { n as callGatewayFromCli, t as addGatewayClientOptions } from "./gateway-rpc-CiFHlkxM.js";
import { t as formatHelpExamples } from "./help-format-Bozi4K9H.js";
import { a as createOutboundSendDeps, n as resolveSessionKeyForRequest, t as agentCommand } from "./agent-CCEnWVbx.js";
import { i as hasExplicitOptions, n as resolveCliChannelOptions, r as ensurePluginRegistryLoaded } from "./channel-options-hBnEjZzp.js";
import { n as parsePositiveIntOrUndefined, t as collectOption } from "./helpers-5yebzF4C.js";
import { i as CONFIGURE_WIZARD_SECTIONS, n as configureCommand, r as configureCommandWithSections } from "./configure-B0lueKAB.js";
import { n as ensureSystemdUserLingerNonInteractive } from "./systemd-linger-N-cIaegf.js";
import "./widearea-dns-D9Al4QRv.js";
import "./auth-health-DUFTo6yO.js";
import { n as loadAndMaybeMigrateDoctorConfig, t as doctorCommand } from "./doctor-3LgNamg_.js";
import "./hooks-status-DepPyfBb.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Config helpers (get/set/unset). Run without subcommand for the wizard.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configure wizard sections (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { CONFIGURE_WIZARD_SECTIONS, configureCommand, configureCommandWithSections } = await import("./configure-B0lueKAB.js").then((n) => n.t);
...
async function dashboardCommand(runtime = defaultRuntime, options = {}) {
	...
	const dashboardUrl = resolveControlUiLinks({
		port,
		bind,
		customBindHost,
		basePath
