import { Ct as printWizardHeader, Et as resolveControlUiLinks, K as readRestartSentinel, Mt as normalizeControlUiBasePath, Ot as summarizeExistingConfig, Pn as getMemorySearchManager, Pt as getRemoteSkillEligibility, St as openUrl, Tt as randomToken, _t as formatControlUiSshHint, at as loadProviderUsageSummary, d as sha256HexPrefix, ft as DEFAULT_WORKSPACE, gt as ensureWorkspaceAndSessions, ht as detectBrowserOpenSupport, kt as waitForGatewayReachable, m as listAgentsForGateway, mr as lookupContextTokens, ot as formatUsageReportLines, pt as applyWizardMetadata, q as summarizeRestartSentinel, wt as probeGatewayReachable, xr as peekSystemEvents, xt as normalizeGatewayTokenInput, yt as handleReset } from "./reply-D5DQmXpo.js";
import { n as DEFAULT_GATEWAY_PORT, u as resolveGatewayPort } from "./paths-scjhy7N2.js";
import { l as normalizeAgentId, v as parseAgentSessionKey } from "./session-key-ezJ78bLC.js";
...
import { c as resolveDefaultAgentId, h as DEFAULT_IDENTITY_FILENAME, p as DEFAULT_BOOTSTRAP_FILENAME, r as resolveAgentDir, s as resolveAgentWorkspaceDir } from "./agent-scope-4nAkb5YL.js";
import { bt as DEFAULT_PROVIDER, d as resolveConfiguredModelRef, lt as ensureAuthProfileStore, vt as DEFAULT_CONTEXT_TOKENS, yt as DEFAULT_MODEL } from "./model-selection-RM_zZLQN.js";
import { r as resolveCliName, t as formatCliCommand } from "./command-format-ChfKqObn.js";
import { c as writeConfigFile, i as loadConfig, j as VERSION, o as readConfigFileSnapshot } from "./config-B1A9pWK-.js";
import { n as listChannelPlugins } from "./plugins-BlF-ZPkH.js";
import { L as resolveMainSessionKey, d as loadSessionStore } from "./sandbox-7ysDY42x.js";
import { d as inspectPortUsage, f as resolveLsofCommandSync, p as formatPortDiagnostics } from "./chrome-BNSd7Bie.js";
import { o as resolveStorePath } from "./paths-CR6bsrfc.js";
import { t as buildChannelSummary } from "./channel-summary-BAdcnl-B.js";
...
import { a as gatewayInstallErrorHint, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-7qf__-lc.js";
...
import { c as promptDefaultModel, d as warnIfModelConfigLooksOff, f as applyAuthChoice, g as promptAuthChoiceGrouped, r as promptRemoteGatewayConfig, s as applyPrimaryModel, t as setupSkills, u as resolvePreferredProviderForAuthChoice } from "./onboard-skills-ClgmyaHf.js";
import { n as setupChannels } from "./onboard-channels-Dct6xrBx.js";
import { l as healthCommand, n as ensureControlUiAssetsBuilt, s as formatHealthChannelLines, t as formatHealthCheckFailure, u as resolveHeartbeatSummaryForAgent } from "./health-format-Cfy9T000.js";
import { C as resolveEffectiveUpdateChannel, S as normalizeUpdateChannel, d as formatUpdateOneLiner, f as getUpdateCheckResult, h as compareSemverStrings, l as ensureCompletionCacheExists, m as checkUpdateStatus, p as resolveUpdateAvailability, s as checkShellCompletionStatus, u as formatUpdateAvailableHint, x as formatUpdateChannelLabel } from "./update-runner-DhTtHXDk.js";
import { i as probeGateway, t as runSecurityAudit } from "./audit-CpNmYoFs.js";
...
import { o as readLastGatewayErrorLine } from "./service-audit-OpgcdI2Y.js";
...
import { r as installCompletion } from "./completion-cli-B576kqUp.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-N-cIaegf.js").then((n) => n.r);
