...
import { A as DEFAULT_OPENCLAW_BROWSER_ENABLED, C as stopChromeExtensionRelayServer, D as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, O as DEFAULT_BROWSER_EVALUATE_ENABLED, S as ensureChromeExtensionRelayServer, a as isChromeCdpReady, b as appendCdpPath, c as resolveOpenClawUserDataDir, g as createTargetViaCdp, j as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, k as DEFAULT_OPENCLAW_BROWSER_COLOR, l as stopOpenClawChrome, n as formatErrorMessage, o as isChromeReachable, s as launchOpenClawChrome, t as extractErrorCode, v as normalizeCdpWsUrl, x as getHeadersWithAuth } from "./errors-CZ9opC6L.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-B7Fvw8DW.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-B7Fvw8DW.js")).closePlaywrightBrowserConnection();
		} catch {}
