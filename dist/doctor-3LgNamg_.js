import { Ct as printWizardHeader, Sr as loadModelCatalog, Tt as randomToken, it as loadOpenClawPlugins, pt as applyWizardMetadata, vt as guardCancel } from "./reply-D5DQmXpo.js";
...
import { i as buildAgentMainSessionKey, l as normalizeAgentId, r as DEFAULT_MAIN_KEY, t as DEFAULT_ACCOUNT_ID } from "./session-key-ezJ78bLC.js";
...
import { c as resolveDefaultAgentId, d as DEFAULT_AGENTS_FILENAME, s as resolveAgentWorkspaceDir } from "./agent-scope-4nAkb5YL.js";
import { $ as resolveApiKeyForProfile, Q as resolveProfileUnusableUntilForDisplay, _t as CODEX_CLI_PROFILE_ID, bt as DEFAULT_PROVIDER, d as resolveConfiguredModelRef, dt as updateAuthProfileStoreWithLock, gt as CLAUDE_CLI_PROFILE_ID, i as getModelRefStatus, it as repairOAuthProfileIdMismatch, lt as ensureAuthProfileStore, p as resolveHooksGmailModel, yt as DEFAULT_MODEL } from "./model-selection-RM_zZLQN.js";
import { t as formatCliCommand } from "./command-format-ChfKqObn.js";
import { t as isTruthyEnvValue } from "./env-0_mKbEWW.js";
import { c as writeConfigFile, n as migrateLegacyConfig, o as readConfigFileSnapshot, u as OpenClawSchema } from "./config-B1A9pWK-.js";
import { n as listChannelPlugins } from "./plugins-BlF-ZPkH.js";
import { L as resolveMainSessionKey, P as canonicalizeMainSessionAlias, Q as resolveSandboxScope, ct as DEFAULT_SANDBOX_BROWSER_IMAGE, d as loadSessionStore, lt as DEFAULT_SANDBOX_COMMON_IMAGE, m as saveSessionStore, ut as DEFAULT_SANDBOX_IMAGE } from "./sandbox-7ysDY42x.js";
import { d as inspectPortUsage, p as formatPortDiagnostics } from "./chrome-BNSd7Bie.js";
import { a as resolveSessionTranscriptsDirForAgent, n as resolveSessionFilePath, o as resolveStorePath } from "./paths-CR6bsrfc.js";
import { n as isWSL, r as isWSLEnv } from "./dispatcher-Cf2jY4zv.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-DtqJOzE9.js";
import { i as readChannelAllowFromStore } from "./pairing-store-DwvRrpqV.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-vzh0MGHs.js";
import { d as resolveGatewaySystemdServiceName, f as resolveGatewayWindowsTaskName, l as resolveGatewayLaunchAgentLabel, m as resolveNodeLaunchAgentLabel } from "./constants-HPrOsATF.js";
import { a as gatewayInstallErrorHint, d as renderSystemNodeWarning, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, p as resolveSystemNodeInfo, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-7qf__-lc.js";
...
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-BQREASgM.js";
import { i as resolveControlUiDistIndexPathForRoot, l as healthCommand, r as resolveControlUiDistIndexHealth, t as formatHealthCheckFailure } from "./health-format-Cfy9T000.js";
import { c as doctorShellCompletion, t as runGatewayUpdate } from "./update-runner-DhTtHXDk.js";
import { a as resolveGatewayBindHost, n as isLoopbackHost } from "./net-C8YRVt16.js";
import { i as resolveGatewayAuth } from "./auth-CbhB03Rz.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-CEvVUD3U.js";
import { a as repairLaunchAgentBootstrap, i as launchAgentPlistExists, n as isLaunchAgentListed, o as resolveGatewayLogPaths, r as isLaunchAgentLoaded, t as resolveGatewayService } from "./service-BZesBIaG.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-B-3NdMmA.js";
import { a as renderGatewayServiceCleanupHints, i as findExtraGatewayServices, n as auditGatewayServiceConfig, o as readLastGatewayErrorLine, r as needsNodeRuntimeMigration, t as SERVICE_AUDIT_CODES } from "./service-audit-OpgcdI2Y.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-CkX23PyE.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-N-cIaegf.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-DUFTo6yO.js";
import { n as renderSystemdUnavailableHints, t as isSystemdUnavailableDetail } from "./systemd-hints-DO88c_nD.js";
