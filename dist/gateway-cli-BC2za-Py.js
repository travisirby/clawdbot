import { B as normalizeElevatedLevel, H as normalizeThinkLevel, I as formatThinkingLevels, K as supportsXHighThinking, L as formatXHighModelHint, U as normalizeUsageDisplay, V as normalizeReasoningLevel, W as normalizeVerboseLevel } from "./pi-embedded-helpers-BINPWZGz.js";
import { $n as resolveTtsProviderOrder, Ar as DEFAULT_INPUT_PDF_MAX_PIXELS, At as CONTROL_UI_AVATAR_PREFIX, B as isGatewaySigusr1RestartExternallyAllowed, Bn as clearInternalHooks, Bt as approveNodePairing, C as readSessionPreviewItemsFromTranscript, Cn as initSubagentRegistry, Cr as DEFAULT_INPUT_FILE_MAX_BYTES, D as ensureOutboundSessionEntry, Dn as getAgentRunContext, Dr as DEFAULT_INPUT_IMAGE_MIMES, En as emitAgentEvent, Er as DEFAULT_INPUT_IMAGE_MAX_BYTES, Fn as resolveAgentIdentity, Fr as normalizeMimeList, Ft as primeRemoteSkillsCache, G as formatRestartSentinelMessage, Gn as OPENAI_TTS_VOICES, Gt as updatePairedNodeMetadata, H as setGatewaySigusr1RestartPolicy, Hn as registerInternalHook, Ht as rejectNodePairing, I as runWithModelFallback, It as recordRemoteNodeInfo, Jn as isTtsProviderConfigured, Jt as registerSkillsChangeListener, Kn as getTtsProvider, Kt as verifyNodeToken, Ln as formatUserTime, Lr as resolveAgentTimeoutMs, Lt as refreshRemoteBinsForConnectedNodes, M as resolveSessionDeliveryTarget, Mr as DEFAULT_INPUT_TIMEOUT_MS, Mt as normalizeControlUiBasePath, Nr as extractFileContentFromSource, Nt as resolveAssistantAvatarUrl, O as resolveOutboundSessionRoute, On as onAgentEvent, Or as DEFAULT_INPUT_MAX_REDIRECTS, P as resetDirectoryCache, Pr as extractImageContentFromSource, Pt as getRemoteSkillEligibility, Q as migrateLegacyCronPayload, Qn as resolveTtsPrefsPath, Qt as isExternalHookSession, R as authorizeGatewaySigusr1Restart, Rn as resolveUserTimeFormat, Rt as refreshRemoteNodeBins, S as readSessionMessages, Sn as stopSubagentsForRequester, Sr as loadModelCatalog, T as stripEnvelopeFromMessages, Tn as clearAgentRunContext, Tr as DEFAULT_INPUT_FILE_MIMES, U as consumeRestartSentinel, Un as triggerInternalHook, Ut as renamePairedNode, V as scheduleGatewaySigusr1Restart, Vn as createInternalHookEvent, Vt as listNodePairing, W as formatDoctorNonInteractiveHint, Wn as OPENAI_TTS_MODELS, Wt as requestNodePairing, X as normalizeCronJobCreate, Xn as resolveTtsAutoMode, Xt as detectSuspiciousPatterns, Y as writeRestartSentinel, Yn as resolveTtsApiKey, Yt as buildSafeExternalPrompt, Z as normalizeCronJobPatch, Zn as resolveTtsConfig, Zt as getHookType, _ as loadSessionEntry, _r as applyVerboseOverride, a as normalizeSendPolicy, an as registerUnhandledRejectionHandler, ar as CommandLane, at as loadProviderUsageSummary, b as archiveFileOnDisk, bn as formatZonedTimestamp, br as isSystemEventContextChanged, c as runEmbeddedPiAgent, cn as resolveHeartbeatVisibility, cr as isDiagnosticsEnabled, dn as onHeartbeatEvent, er as setTtsEnabled, f as createOpenClawTools, g as loadCombinedSessionStoreForGateway, gr as applyModelOverrideToSessionEntry, h as listSessionsFromStore, hn as getChannelActivity, i as runCliAgent, ir as setCommandLaneConcurrency, it as loadOpenClawPlugins, j as resolveOutboundTarget, jn as normalizePollInput, jr as DEFAULT_INPUT_PDF_MIN_TEXT_CHARS, jt as buildControlUiAvatarUrl, kn as registerAgentRunContext, kr as DEFAULT_INPUT_PDF_MAX_PAGES, l as abortEmbeddedPiRun, lr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, m as listAgentsForGateway, mr as lookupContextTokens, n as getCliSessionId, nn as createReplyPrefixOptions, nr as textToSpeech, o as resolveSendPolicy, or as startDiagnosticHeartbeat, p as resolveAnnounceTargetFromKey, pr as stripHeartbeatToken, q as summarizeRestartSentinel, qn as isTtsEnabled, qt as getSkillsSnapshotVersion, r as setCliSessionId, rn as normalizeGroupActivation, rt as getPluginToolMeta, s as clearSessionQueues, sn as buildHistoryContextFromEntries, sr as stopDiagnosticHeartbeat, tr as setTtsProvider, tt as requestHeartbeatNow, u as waitForEmbeddedPiRunEnd, un as getLastHeartbeatEvent, ut as handleSlackHttpRequest, v as resolveGatewaySessionStoreTarget, vn as dispatchInboundMessage, vr as parseVerboseOverride, w as resolveSessionTranscriptCandidates, wr as DEFAULT_INPUT_FILE_MAX_CHARS, x as capArrayByJsonBytes, xn as isAbortTrigger, y as resolveSessionModelRef, yn as createReplyDispatcher, yr as enqueueSystemEvent, yt as handleReset, z as consumeGatewaySigusr1RestartAuthorization, zn as resolveUserTimezone, zt as setSkillsRemoteRegistry } from "./reply-D5DQmXpo.js";
...
import { _ as isSubagentSessionKey, d as resolveAgentIdFromSessionKey, i as buildAgentMainSessionKey, l as normalizeAgentId, m as toAgentRequestSessionKey, t as DEFAULT_ACCOUNT_ID, u as normalizeMainKey, v as parseAgentSessionKey } from "./session-key-ezJ78bLC.js";
...
import { c as saveMediaBuffer, l as detectMime } from "./routes-D-UAHT8-.js";
...
import { n as resolveSessionFilePath, o as resolveStorePath, r as resolveSessionTranscriptPath } from "./paths-CR6bsrfc.js";
import "./redact-DJCFY628.js";
import "./tool-display-BxZG0o1b.js";
import { o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads } from "./deliver-DsD2VjZR.js";
import { i as getMachineDisplayName, t as createBrowserRouteDispatcher } from "./dispatcher-Cf2jY4zv.js";
...
import { n as callGateway, o as loadGatewayTlsRuntime$1 } from "./call-DtqJOzE9.js";
...
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy, t as filterToolsByPolicy } from "./pi-tools.policy-nqJPBQaE.js";
import "./prompt-style-vzh0MGHs.js";
import "./pairing-labels-CCiIuKc3.js";
import { i as loadSessionUsageTimeSeries, l as hasNonzeroUsage, n as loadCostUsageSummary, r as loadSessionCostSummary, t as discoverAllSessions } from "./session-cost-usage-C5MMXOZi.js";
import { n as formatTokenCount, r as formatUsd } from "./usage-format-DvowRSs-.js";
import { c as normalizeExecApprovals, g as saveExecApprovals, l as readExecApprovalsSnapshot, m as resolveExecApprovalsSocketPath, r as ensureExecApprovals } from "./exec-approvals-DmzWB9Zy.js";
import { n as createBrowserControlContext, r as startBrowserControlServiceFromConfig } from "./control-service-Cvxcu5h2.js";
import { t as parseAbsoluteTimeMs } from "./parse-BZz5lHzQ.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-BPXp-Ft6.js";
import { n as createOutboundSendDeps, t as createDefaultDeps } from "./deps-Cungkzfd.js";
...
import "./daemon-runtime-7qf__-lc.js";
import { c as loadAgentIdentity, d as loadAgentIdentityFromWorkspace, p as forceFreePortAndWait, r as getStatusSummary, t as runOnboardingWizard } from "./onboarding-BlJrKxt5.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-CSZtxHTa.js";
import "./logging-TXWhN8jG.js";
import "./note-B5HnoeZX.js";
import { t as WizardCancelledError } from "./prompts-FbZThK8w.js";
import { i as discoverGatewayBeacons, n as installSkill } from "./onboard-skills-ClgmyaHf.js";
import "./github-copilot-auth-CIyJs5fn.js";
import "./onboard-channels-Dct6xrBx.js";
import { r as buildChannelUiCatalog, t as applyPluginAutoEnable } from "./plugin-auto-enable-BQREASgM.js";
import "./archive-Dy3Ezb-5.js";
import "./skill-scanner-BoGjHXUZ.js";
import "./installs-BhEjOqPy.js";
import { a as resolveControlUiRootOverrideSync, c as getHealthSnapshot, d as runHeartbeatOnce, f as setHeartbeatsEnabled, n as ensureControlUiAssetsBuilt, o as resolveControlUiRootSync, p as startHeartbeatRunner, s as formatHealthChannelLines } from "./health-format-Cfy9T000.js";
import { S as normalizeUpdateChannel, _ as resolveNpmChannelTag, h as compareSemverStrings, m as checkUpdateStatus, t as runGatewayUpdate, y as DEFAULT_PACKAGE_CHANNEL } from "./update-runner-DhTtHXDk.js";
...
import { i as probeGateway } from "./audit-CpNmYoFs.js";
...
import "./service-audit-OpgcdI2Y.js";
import "./node-service-BAYHx0E7.js";
import "./channels-status-issues-CkX23PyE.js";
import "./completion-cli-B576kqUp.js";
import { a as createOutboundSendDeps$1, i as resolveAgentOutboundTarget, r as resolveAgentDeliveryPlan, t as agentCommand } from "./agent-CCEnWVbx.js";
...
import "./tui-CZSiGSHy.js";
import { t as buildChannelAccountSnapshot } from "./status-tCu4RWZH.js";
import "./shared-BmtNKsPq.js";
import { a as runDaemonStop, i as runDaemonStart, n as runDaemonStatus, o as runDaemonUninstall, r as runDaemonRestart, s as runDaemonInstall } from "./daemon-cli-rzLkwmmk.js";
...
import { i as setGatewayWsLogStyle, n as logWs, r as summarizeAgentEventForWsLog, t as formatForLog } from "./ws-log-DoIdOhb1.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-C1L9ygf2.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		const { loadSessionLogs } = await import("./session-cost-usage-C5MMXOZi.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./control-service-Cvxcu5h2.js").then((n) => n.t);
