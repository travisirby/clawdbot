...
import { N as resolveConfiguredModelRef, _ as ensureAuthProfileStore, _t as DEFAULT_PROVIDER, gt as DEFAULT_MODEL, ht as DEFAULT_CONTEXT_TOKENS } from "./auth-profiles-CbjyhfM5.js";
...
import { c as writeConfigFile, i as loadConfig, j as VERSION, o as readConfigFileSnapshot } from "./config-BK7bfee5.js";
...
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-BJSLz4K5.js";
import { n as listChannelPlugins } from "./plugins-DmOwDqqs.js";
import { $t as listAgentsForGateway, At as sha256HexPrefix, In as readRestartSentinel, Ln as summarizeRestartSentinel, Or as getMemorySearchManager, Xt as formatUsageReportLines, Yt as loadProviderUsageSummary, _ as randomToken, a as applyWizardMetadata, b as summarizeExistingConfig, c as ensureWorkspaceAndSessions, d as handleReset, fn as lookupContextTokens, g as probeGatewayReachable, h as printWizardHeader, i as DEFAULT_WORKSPACE, l as formatControlUiSshHint, m as openUrl, p as normalizeGatewayTokenInput, q as getRemoteSkillEligibility, qn as peekSystemEvents, s as detectBrowserOpenSupport, v as resolveControlUiLinks, w as normalizeControlUiBasePath, x as waitForGatewayReachable } from "./loader-PqvF84Si.js";
...
import { I as resolveMainSessionKey, d as loadSessionStore } from "./sandbox-CAzTXzmk.js";
import { t as buildChannelSummary } from "./channel-summary-B_C4bXX1.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-NwwdCTbZ.js";
import { r as installCompletion } from "./completion-cli-B9IXLgiC.js";
import { a as gatewayInstallErrorHint, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-BcBr8yJC.js";
import { o as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-_JwSmGSn.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-8sIc6isV.js";
import { o as readLastGatewayErrorLine } from "./service-audit-CiV3R13m.js";
import { t as renderTable } from "./table-CJSx0YID.js";
import { i as probeGateway, t as runSecurityAudit } from "./audit-CiOqbn9_.js";
import { d as applyAuthChoice, h as promptAuthChoiceGrouped, l as resolvePreferredProviderForAuthChoice, o as applyPrimaryModel, r as promptRemoteGatewayConfig, s as promptDefaultModel, t as setupSkills, u as warnIfModelConfigLooksOff } from "./onboard-skills-BQDd1fcD.js";
import { l as healthCommand, n as ensureControlUiAssetsBuilt, s as formatHealthChannelLines, t as formatHealthCheckFailure, u as resolveHeartbeatSummaryForAgent } from "./health-format-B5Hg8mtj.js";
import { C as resolveEffectiveUpdateChannel, S as normalizeUpdateChannel, c as formatUpdateOneLiner, d as checkShellCompletionStatus, h as compareSemverStrings, l as getUpdateCheckResult, m as checkUpdateStatus, p as ensureCompletionCacheExists, s as formatUpdateAvailableHint, u as resolveUpdateAvailability, x as formatUpdateChannelLabel } from "./update-runner-BNcrduqF.js";
import { n as logConfigUpdated } from "./logging-Cc7m6PTv.js";
import { t as buildWorkspaceHookStatus } from "./hooks-status-CKmUPU-M.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-DtXrj3fy.js";
import { t as runTui } from "./tui-D2aYfza-.js";
import { t as resolveNodeService } from "./node-service-Lc1LlnFH.js";
import { i as redactSecrets, n as formatDuration$1, r as formatGatewayAuthUsed, t as formatAge$1 } from "./format-CS7EI0xF.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-SsSOsJST.js").then((n) => n.r);
